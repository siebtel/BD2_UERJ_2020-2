...
-- -----------------------------------------------------
-- Table `BDI-db`.`Funcionario_has_Brinquedos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `BDI-db`.`Funcionario_has_Brinquedos` (
...
-- -----------------------------------------------------
-- Table `BDI-db`.`Cartao_cobranca_has_Brinquedos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `BDI-db`.`Cartao_cobranca_has_Brinquedos` (
