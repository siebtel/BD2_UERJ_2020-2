...
CREATE TABLE IF NOT EXISTS `mydb`.`Cartao_cobranca` (
  ...
  PRIMARY KEY (`Data`, `Hora`, `Cliente_CPF`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`Cartao_cobranca_has_Brinquedos` (
  ...
  `Brinquedos_Cod_brinquedo` INT NOT NULL,
  PRIMARY KEY (`Cartao_cobranca_Data`, `Cartao_cobranca_Hora`, `Cartao_cobranca_Cliente_CPF`, `Brinquedos_Cod_brinquedo`),
  INDEX `fk_Cartao_cobranca_has_Brinquedos_Brinquedos1_idx` (`Brinquedos_Cod_brinquedo` ASC),
  INDEX `fk_Cartao_cobranca_has_Brinquedos_Cartao_cobranca1_idx` (`Cartao_cobranca_Data` ASC, `Cartao_cobranca_Hora` ASC, `Cartao_cobranca_Cliente_CPF` ASC),
  CONSTRAINT `fk_Cartao_cobranca_has_Brinquedos_Cartao_cobranca1`
    FOREIGN KEY (`Cartao_cobranca_Data` , `Cartao_cobranca_Hora` , `Cartao_cobranca_Cliente_CPF`)
    REFERENCES `mydb`.`Cartao_cobranca` (`Data` , `Hora` , `Cliente_CPF`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
